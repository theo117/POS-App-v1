...
REM Build and package JavaPOS as a Windows MSI without Ant.
...
if errorlevel 1 (
  ...
  echo If the error mentions WiX, install WiX Toolset and rerun.
  pause
  exit /b 1
)

echo.
echo [SUCCESS] MSI created in: %OUT_DIR%
pause
endlocal
